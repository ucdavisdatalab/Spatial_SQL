...
This query will return a single column and row. Refresh your *Browser* again and the icon should change to a polygon.  Now we need to vacuum the database (yes, that sounds a little odd).  Right click on the database name in the *Browser*, select *Compact Database (VACUUM)*.
