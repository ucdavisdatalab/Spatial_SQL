...
Now we're just about ready to do some analysis with our database.  Click on the *SQL Window* Icon. ![alt text](./images/QGIS_SQLWindow.png "SQL Window icon has a wrench on top of a page with writing") You may need to expand the window by dragging the lower right corner of the window out so you can see everything.
